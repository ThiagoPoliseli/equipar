      ...
      <section className="relative min-h-screen flex items-center justify-center py-16 px-4">
        ...
        <div className="relative text-center text-white z-10 max-w-4xl w-full">
          ...
          <p className="text-base sm:text-lg md:text-xl leading-relaxed px-2 sm:px-6">
            Fundada em 2019, se destaca pela excelência no fornecimento de
            equipamentos médicos, hospitalares e odontológicos, além de serviços
            de assistência técnica especializada. A empresa tem como objetivo
            ser referência em qualidade e inovação, priorizando sempre a
            segurança e um atendimento personalizado aos seus clientes. O
            portfólio inclui produtos de alto desempenho, oferecendo soluções
            completas para hospitais, clínicas e consultórios odontológicos. Com
            uma equipe altamente capacitada e comprometida, a Equipar garante
            não apenas a entrega dos melhores produtos, mas também suporte
            técnico de confiança, assegurando o perfeito funcionamento dos
            equipamentos.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-blue-100 leading-relaxed">
              Desde 2019, a EQUIPAR tem se destacado no mercado de equipamentos
              médicos e hospitalares, construindo uma reputação sólida baseada
              na qualidade dos produtos e excelência no atendimento. Nossa
              missão é fornecer soluções que contribuam para o avanço da saúde
              no Brasil.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center group bg-white/10 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-blue-100">
                Trabalhamos apenas com marcas reconhecidas mundialmente,
                garantindo a procedência e confiabilidade de todos os nossos
                produtos.
              </p>
            </div>
            <div className="text-center group bg-white/10 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-blue-100">
                Nossa equipe técnica altamente qualificada está disponível todos
                os momentos para garantir o funcionamento adequado dos
                equipamentos.
              </p>
            </div>
            <div className="text-center group bg-white/10 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
      ...
      >
        <div className="max-w-6xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-blue-100">
              Oferecemos uma ampla gama de equipamentos médicos e hospitalares
              das melhores marcas do mercado. Todos os produtos possuem
              certificação ANVISA e garantia estendida.
            </p>
          </div>
          <ProductCatalog />
        </div>
      ...
      >
        <div className="max-w-6xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-blue-100">
              Estamos à disposição para esclarecer suas dúvidas, realizar
              orçamentos e oferecer o melhor atendimento para suas necessidades.
            </p>
          </div>
      ...
      <footer className="bg-gradient-to-r from-[#002c5a] to-[#001f40] text-white py-12">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="border-t border-white/10 pt-8 text-center text-blue-100">
            <p>
              &copy; 2025 EQUIPAR Produtos Médicos Hospitalares LTDA. Todos os
              direitos reservados.
            </p>
          </div>
        </div>
